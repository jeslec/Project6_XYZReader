...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton refreshFAB = (FloatingActionButton)findViewById(R.id.refresh_news_fab);

        // Reload the news if user taps on floating action button
        refreshFAB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                refresh();
                Snackbar.make(v, R.string.refresh_fab_snackbar_msg, Snackbar.LENGTH_LONG).show();
            }
        });

        // Reload the news if user does a swipe down gesture
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            Log.d(TAG, String.format("onBindViewHolder() - AspectRatio: %f   Url: %s", aspectRatio, url));
            //--
